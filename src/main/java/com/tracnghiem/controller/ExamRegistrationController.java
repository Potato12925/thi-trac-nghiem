...
public class ExamRegistrationController {
	...
	@PostMapping("/add")
	public String add(@Validated @ModelAttribute("registrationDTO") ExamRegistrationDTO dto,
			BindingResult bindingResult, ModelMap model, HttpSession session, RedirectAttributes redirectAttributes) {
	...
	public String delete(@ModelAttribute("registrationDTO") ExamRegistrationDTO dto, HttpSession session,
		...
		try {
			examRegistrationService.deleteExam(dto.getClassId(), dto.getSubjectId(), dto.getTryNumber(), userMaGv,
					role);
