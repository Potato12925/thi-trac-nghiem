...
"Quản lý Giảng viên"); %> <%@ include file="../Shared/_LayoutStart.jsp" %>
    ...
    <form class="row g-3">
      <div class="col-md-4">
        ...
        <select class="form-select form-select-sm">
          <option selected>Tất cả khoa</option>
      ...
      <table class="table table-hover align-middle mb-0">
        <thead class="table-light">
          <tr>
            ...
            <th scope="col">Học vị / Học hàm</th>
        ...
        <tbody>
          <tr>
            <td class="fw-medium text-success">GV01</td>
            <td>TS. Nguyễn Thanh Tuấn</td>
            <td>Tiến sĩ</td>
            <td>CNTT</td>
            <td class="text-end">
          ...
          <tr>
            <td class="fw-medium text-success">GV02</td>
            <td>ThS. Lê Thị Ái</td>
            <td>Thạc sĩ</td>
            <td>CNTT</td>
            <td class="text-end">
