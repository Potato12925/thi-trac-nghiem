                    ...
                    <%@ include file="../Shared/_LayoutStart.jsp" %>
                        <div class="container-fluid">
                            ...
                            <div class="border rounded-3 bg-white p-4 mb-4">
                                ...
                                <form:form id="examRegistrationForm"
                                    action="${pageContext.request.contextPath}/exam-registration/add" method="post"
                                        ...
                                        <c:if test="${sessionScope.ROLE eq 'PGV'}">
                                            <div class="col-md-3">
                                                <label class="form-label small text-secondary">Giáo Viên <span
                                                        class="text-danger">*</span></label>
                                                <form:select path="teacherId" class="form-select" id="teacherId">
                                                    <option value="">-- Chọn giáo viên --</option>
                                                    <c:forEach items="${dsGiaoVien}" var="gv">
                                                        <option value="${gv.teacherId}">${gv.teacherId} - ${gv.lastName}
                                                            ${gv.firstName}
                                                        </option>
                                                    </c:forEach>
                                                </form:select>
                        ...
                        <script>
                            function fillFormFromRow(row) {
                                ...
                                const teacherId = cells[4].innerText.trim();
