...
<style>
    ...
    .profile-card {
        ...
        border: 0;
        border-radius: 26px;
        background: linear-gradient(135deg, #1d4ed8, #2563eb 50%, #38bdf8);
        color: #fff;
...
<div class="container-fluid settings-shell">
    ...
    <section class="card profile-card">
        <div class="card-body">
            <div class="profile-title">${studentProfile.lastName} ${studentProfile.firstName}</div>
    ...
    <section class="card settings-panel">
        <button class="settings-toggle"
                ...
                data-bs-target="#studentEmailSettings"
                aria-expanded="${showEmailPanel ? 'true' : 'false'}"
                aria-controls="studentEmailSettings">
            <span>
        ...
        <div id="studentEmailSettings" class="collapse ${showEmailPanel ? 'show' : ''}">
    ...
    <section class="card settings-panel">
        <button class="settings-toggle"
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#studentPasswordSettings"
                aria-expanded="${showPasswordPanel ? 'true' : 'false'}"
                aria-controls="studentPasswordSettings">
            <span>
        ...
        <div id="studentPasswordSettings" class="collapse ${showPasswordPanel ? 'show' : ''}">
            <div class="settings-body">
